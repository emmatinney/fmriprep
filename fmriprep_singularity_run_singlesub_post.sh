...
BIDS_DIR="${STUDY}"
DERIVS_DIR=/derivatives_post/fmriprep
LOCAL_FREESURFER_DIR="${BIDS_DIR}/derivatives_post/freesurfer"
CONTAINER_PATH=/shared/container_repository/fmriprep/23.0.2
CONTAINER_NAME=fmriprep_23.0.2.sif

# Prepare some writeable bind-mount points.
TEMPLATEFLOW_HOST_HOME=/scratch/$USER/my_fmriprep_post/.cache/templateflow
FMRIPREP_HOST_CACHE=/scratch/$USER/my_fmriprep_post/.cache/fmriprep
...
cmd="${SINGULARITY_CMD} /data /data/${DERIVS_DIR} participant --participant-label 01 -w /work/ -vv --omp-nthreads 8 --nthreads 12 --mem_mb 30000 --output-spaces MNI152NLin2009cAsym:res-2 anat fsnative fsaverage5 --use-aroma --fs-subjects-dir /fsdir --skip_bids_validation --bids-filter-file /data/filter-file_post.json"
